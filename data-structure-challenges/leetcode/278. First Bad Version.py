...
Learnings:
- Solved with binary search. O(logn) since the search space is halved at every iteration
- In order to avoid overflow if left + right > MAX_INT, better to update mid with left + (right-left) / 2
"""
